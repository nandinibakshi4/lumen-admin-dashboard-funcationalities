  ...
  const renderSubscriptions = () => (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <Button className="bg-teal-600 hover:bg-teal-700">Add New Subscription</Button>
      </div>
      ...
      <Card>
        <Table>
          <TableHeader>
            <TableRow className="bg-teal-600 hover:bg-teal-600 border-none">
              <TableHead className="text-white font-semibold bg-teal-600">User Name</TableHead>
              <TableHead className="text-white font-semibold bg-teal-600">Plan Name</TableHead>
            ...
            {subscriptionsData.map((subscription) => (
              <TableRow key={subscription.id}>
                ...
                <TableCell>
                  <span
                    className={`px-2 py-1 rounded text-xs font-medium ${
                      subscription.status === "active" ? "text-green-700 bg-green-100" : "text-red-700 bg-red-100"
                    }`}
                  >
                    {subscription.status}
                  </span>
  ...
  const renderUsage = () => (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <Button className="bg-teal-600 hover:bg-teal-700">Track Usage</Button>
      </div>
        ...
        <Table>
          <TableHeader>
            <TableRow className="bg-teal-600 hover:bg-teal-600 border-none">
              ...
              <TableHead className="text-white font-semibold bg-teal-600">Quota</TableHead>
              <TableHead className="text-white font-semibold bg-teal-600">Month</TableHead>
              <TableHead className="text-white font-semibold bg-teal-600">Year</TableHead>
              <TableHead className="text-white font-semibold bg-teal-600">Percentage</TableHead>
              <TableHead className="text-white font-semibold bg-teal-600">Actions</TableHead>
            </TableRow>
          </TableHeader>
  ...
  const renderAnalytics = () => (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <Button className="bg-teal-600 hover:bg-teal-700">View Analytics</Button>
      </div>
      ...
      <Card>
        <Table>
          <TableHeader>
            <TableRow className="bg-teal-600 hover:bg-teal-600 border-none">
              <TableHead className="text-white font-semibold bg-teal-600">Metric</TableHead>
              <TableHead className="text-white font-semibold bg-teal-600">Value</TableHead>
              <TableHead className="text-white font-semibold bg-teal-600">Actions</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            ...
            <TableRow>
              <TableCell className="font-medium">Total Subscriptions</TableCell>
            ...
            <TableRow>
              <TableCell className="font-medium">Cancelled Subscriptions</TableCell>
  ...
  const renderUserActivity = () => (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <Button className="bg-teal-600 hover:bg-teal-700">View Activity</Button>
      </div>
      ...
      <Card>
        <Table>
          <TableHeader>
            <TableRow className="bg-teal-600 hover:bg-teal-600 border-none">
              <TableHead className="text-white font-semibold bg-teal-600">User Name</TableHead>
              <TableHead className="text-white font-semibold bg-teal-600">Activity</TableHead>
          ...
          <TableBody>
            ...
            <TableRow>
              ...
              <TableCell>2024-09-13 10:00:00</TableCell>
              <TableCell>
                <div className="flex gap-2">
                  <Button size="sm" variant="outline" className="h-8 px-3 bg-transparent">
                    <Edit className="h-3 w-3 mr-1" />
            ...
            <TableRow>
              ...
              <TableCell>2024-09-13 11:00:00</TableCell>
              <TableCell>
                <div className="flex gap-2">
                  <Button size="sm" variant="outline" className="h-8 px-3 bg-transparent">
                    <Edit className="h-3 w-3 mr-1" />
  ...
  const renderAuditLogs = () => (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <Button className="bg-teal-600 hover:bg-teal-700">View Logs</Button>
      </div>
      ...
      <Card>
        <Table>
          <TableHeader>
            <TableRow className="bg-teal-600 hover:bg-teal-600 border-none">
              <TableHead className="text-white font-semibold bg-teal-600">Actor Name</TableHead>
  ...
  const renderNotifications = () => (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <Button className="bg-teal-600 hover:bg-teal-700">Send Notification</Button>
      </div>
      ...
      <Card>
        <Table>
          <TableHeader>
            <TableRow className="bg-teal-600 hover:bg-teal-600 border-none">
              <TableHead className="text-white font-semibold bg-teal-600">User Name</TableHead>
              <TableHead className="text-white font-semibold bg-teal-600">Notification</TableHead>
              <TableHead className="text-white font-semibold bg-teal-600">Timestamp</TableHead>
              <TableHead className="text-white font-semibold bg-teal-600">Actions</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            ...
            <TableRow>
              <TableCell className="font-medium">John Doe</TableCell>
              <TableCell>New plan available</TableCell>
              <TableCell>2024-09-13 12:00:00</TableCell>
              <TableCell>
                <div className="flex gap-2">
                  <Button size="sm" variant="outline" className="h-8 px-3 bg-transparent">
                    <Edit className="h-3 w-3 mr-1" />
            ...
            <TableRow>
              <TableCell className="font-medium">Jane Smith</TableCell>
              <TableCell>Subscription expired</TableCell>
              <TableCell>2024-09-13 13:00:00</TableCell>
              <TableCell>
                <div className="flex gap-2">
                  <Button size="sm" variant="outline" className="h-8 px-3 bg-transparent">
                    <Edit className="h-3 w-3 mr-1" />
